...
func (i SceneResource) getFilters(req *restful.Request, resp *restful.Response) {
	...
	outAttributes = append(outAttributes, "Has No Cup Size")
	outAttributes = append(outAttributes, "Has AA Cup Size")
	outAttributes = append(outAttributes, "Has A Cup Size")
	outAttributes = append(outAttributes, "Has B Cup Size")
